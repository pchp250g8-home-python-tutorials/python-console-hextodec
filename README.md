HexToDec. Python tutorials. Simple Input/Output. Algorithms. Strings. Console Application. 
...
HexToDec. Занятия по Python. Простой Ввод-вывод. Алгоритмы. Строки. Консольное приложение. 
...
Программа делает следующее:
  ...
  5. Выполняется цикл с параметром.
     ...
     5.2. Выполняется серия цикла.
          ...
          5.2.4. Переменная множителя степени 8 умножается на 8, так как число двоичное. 
